...
class FuzzyTripFinalStopLookupAsyncFunctionTest {
  ...
  @Test
  void shouldUseCorrectDepartureTime() throws Exception {
  ...
  private OneInputStreamOperatorTestHarness<
          Tuple2<Instant, VehiclePosition>, Tuple2<VehiclePosition, Long>>
      createHarness(
          AsyncFunction<Tuple2<Instant, VehiclePosition>, Tuple2<VehiclePosition, Long>> function)
          throws Exception {
