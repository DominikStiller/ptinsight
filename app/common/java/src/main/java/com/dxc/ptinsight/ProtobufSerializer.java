...
public class ProtobufSerializer {
    ...
    private static final JsonFormat.Printer jsonPrettyPrinter = JsonFormat.printer()
                                                                          .includingDefaultValueFields()
                                                                          .preservingProtoFieldNames()
                                                                          .usingTypeRegistry(Registry.INSTANCE);
    private static final JsonFormat.Printer jsonPrinter = jsonPrettyPrinter.omittingInsignificantWhitespace();
    private static final JsonFormat.Parser jsonParser = JsonFormat.parser().usingTypeRegistry(Registry.INSTANCE);
